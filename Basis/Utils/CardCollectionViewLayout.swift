...
/*
 https://github.com/satishVekariya/PushpaCollectionViewLayout
 Utilizing the Custom Layout file to replicate a card layout view within a UICollectionView and not the libraries available to replicate tinder like card view since the Drag Gesture would intervene with the Right Swipe gesture to bring back the previous card, this will bring out irregular results.
*/
class CardCollectionViewLayout: UICollectionViewLayout {
    ...
    public var spacing:CGFloat = 0 { didSet { invalidateLayout() } }
    public var leftSpace:CGFloat = 0 { didSet { invalidateLayout() } }
    ...
    fileprivate func getAttribute(for indexPath:IndexPath) -> UICollectionViewLayoutAttributes {
        ...
        case 1..<maximumVisibleItems:
            ...
            attr.center.y -= CGFloat(-10 * firstVisibleIndex)
